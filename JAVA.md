...
## JAVA_HOME
**In `shell` like `.bashrc or .zshrc` file added path of `JAVA_HOME`**
```
# JAVA_HOME path config, please change the specific java-version path as you need
export JAVA_HOME="$HOME/.asdf/installs/java/zulu-musl-22.30.13"
```
export JAVA_HOME="$HOME/.asdf/installs/java/zulu-musl-22.30.13"
